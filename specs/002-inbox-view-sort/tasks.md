...
- [ ] T080 [P] Automated offline assertion: run the core sort suite with network access denied and confirm no code path attempts a connection, in `packages/core/tests/sort-offline.test.ts` (FR-031, SC-008)
